function [J_grad, cost, grad] = softmaxCost2(theta, numClasses, inputSize, lambda, data, labels)
...
J_grad = theta' * (groundTruth - ( bsxfun(@rdivide , exp_theta_x,  sum(exp_theta_x)  ) ) );
